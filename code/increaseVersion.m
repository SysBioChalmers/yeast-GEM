...
cd ../modelTests
new.flux = anaerobic_flux_predictions(modelAnaerobic);
...
searchRes = {'^(- Model version\: )[^\n]*', ...
             ...
             '^(\| Anaerobic flux median fold error \| )[\d.eE+-]+', ...
             '^(\| Anaerobic flux mean fold error \| )[\d.eE+-]+', ...
             '^(\| Anaerobic flux within 2-fold \| )[\d.eE+-]+', ...
             '^(\| Anaerobic fluxes with no comparable ratio \| )[\d.eE+-]+', ...
...
newRes    = {['$1' newVersion], ...
             ...
             ['$1' num2str(new.flux.medianFoldError,'%.16g')], ...
             ['$1' num2str(new.flux.meanFoldError,'%.16g')], ...
             ['$1' num2str(new.flux.withinTwoFold,'%.16g')], ...
             ['$1' num2str(new.flux.unpredicted)], ...
             ['$1' num2str(new.flux.R2,'%.16g')], ...
    ...
    if length(diff_i) == 3
        switch diff_i{3}
            ...
            case {'history.md','README.md','model/yeast-GEM.mat','model/yeast-GEM.xlsx', ...
                  ...
                  'data/testResults/growth.png','data/testResults/essentialGenes.tsv', ...
                  'data/testResults/qc_findings.md','data/testResults/qc_metrics.tsv', ...
                  'data/testResults/validation_metrics.tsv'}
            otherwise
