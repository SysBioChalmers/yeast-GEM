...
model.lb(strcmp(model.rxns,'r_0501'))=0; %glycine cleavage, mitochondrion
model.ub(strcmp(model.rxns,'r_0501'))=1000;
model.lb(strcmp(model.rxns,'r_0507'))=0; %glycine cleavage complex (lipoylprotein), mitochondrion
model.ub(strcmp(model.rxns,'r_0507'))=1000;
model.lb(strcmp(model.rxns,'r_0509'))=0; %glycine cleavage complex (lipoamide), mitochondrion
model.ub(strcmp(model.rxns,'r_0509'))=1000;
end
