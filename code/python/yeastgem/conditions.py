"""Yeast-GEM condition presets — yeast-specific wrapper over raven-toolbox.
...
:func:`raven_toolbox.conditions.apply_condition`. yeast-GEM contributes:
...
def apply(model: cobra.Model, name: str) -> cobra.Model:
    ...
    3. Hand the parsed config to
       :func:`raven_toolbox.conditions.apply_condition` for the generic
