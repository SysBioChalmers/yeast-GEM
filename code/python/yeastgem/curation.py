...
Thin wrapper over :func:`raven_toolbox.curation.batch_curate` (and its
...
upstream — see ``raven_toolbox.curation`` for the full reference.
...
def curate_mets_rxns_genes(
    ...
    *,
    ...
    :func:`raven_toolbox.curation.batch_curate`. See its docstring for
