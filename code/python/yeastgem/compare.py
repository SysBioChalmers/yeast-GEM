...
The implementation moved to ``raven_toolbox.comparison.diff`` (the
...
new code should import from ``raven_toolbox.comparison`` directly.
"""
from __future__ import annotations

from raven_toolbox.comparison import (
